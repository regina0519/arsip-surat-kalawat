 ...
 * @author Regina
 */
public class FormInputXXX extends JMPCForm {
    
    
    /**
     * Creates new form FormInputXXX
     */
    public FormInputXXX() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormInputXXX.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormInputXXX().setVisible(true);
            }
        });
    }
